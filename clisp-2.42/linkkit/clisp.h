...
#define VALID_FILENAME_CHAR (ch >= 1) && (ch <= 127) && (ch != 34) && (ch != 42) && (ch != 47) && (ch != 58) && (ch != 60) && (ch != 62) && (ch != 63) && (ch != 92) || (ch == 131) || (ch >= 160) && (ch != 197) && (ch != 206)
...
#define builtin_stream_p(obj)  ((((oint)(obj) & 3) == (1UL+0)) && (((sintB)((((Record)((oint)(obj)-1UL)))->tfl & 0xFF)) == Rectype_Stream))
...
extern struct subr_tab_ {
  ...
  subr_t D_cs_string_gleich;
  subr_t D_string_ungleich;
  subr_t D_cs_string_ungleich;
  subr_t D_string_kleiner;
  subr_t D_cs_string_kleiner;
  subr_t D_string_groesser;
  subr_t D_cs_string_groesser;
  subr_t D_string_klgleich;
  subr_t D_cs_string_klgleich;
  subr_t D_string_grgleich;
  subr_t D_cs_string_grgleich;
  ...
  subr_t D_sizeof;
  subr_t D_bitsizeof;
  subr_t D_lookup_foreign_variable;
  ...
  subr_t D_lookup_foreign_function;
  subr_t D_find_foreign_function;
  subr_t D_foreign_call_out;
  subr_t D_foreign_library;
  subr_t D_close_foreign_library;
  subr_t D_foreign_library_variable;
  subr_t D_foreign_library_function;
} subr_tab_data;
...
extern struct symbol_tab_ {
  ...
  symbol_ S_cs_string_gleich;
  symbol_ S_string_ungleich;
  symbol_ S_cs_string_ungleich;
  symbol_ S_string_kleiner;
  symbol_ S_cs_string_kleiner;
  symbol_ S_string_groesser;
  symbol_ S_cs_string_groesser;
  symbol_ S_string_klgleich;
  symbol_ S_cs_string_klgleich;
  symbol_ S_string_grgleich;
  symbol_ S_cs_string_grgleich;
  ...
  symbol_ S_foreign_library;
  symbol_ S_close_foreign_library;
  symbol_ S_foreign_library_variable;
  symbol_ S_foreign_library_function;
...
#define STACK_to_mv(countx)  do { uintWL count = (countx); mv_count = count; if (count == 0) mv_space[0] = ((object)((UBYTE*)(&symbol_tab_data.S_nil)+(1UL))); else { object* mvp = &mv_space[count]; do { ; { count = (count); do {{ *--mvp = (STACK -= 1, (STACK[-1-(sintP)(-1)])); }} while(!(--count==0)); }; } while(0); } } while(0)
...
#define LISPFUN_B(name,sec,req_anz,opt_anz,rest_flag,key_flag,key_anz,keywords)  Values C_##name subr_##rest_flag##_function_args; Values C_##name subr_##rest_flag##_function_args
#define subr_norest_function_args  (void)
#define subr_rest_function_args  (uintC argcount, object* rest_args_pointer)
#define LISPFUN_F(name,sec,req_anz,opt_anz,rest_flag,key_flag,key_anz,keywords)  { gcv_nullobj, 268566568UL, gcv_nullobj, gcv_nullobj, (lisp_function_t)(&C_##name), 0, req_anz, opt_anz, (uintB)subr_##rest_flag, (uintB)subr_##key_flag, key_anz, sec},
